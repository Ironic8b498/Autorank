    ...
    public void execute(String sql) {
        ...
        if (this.isConnected()) {
            try {
                ...
                System.out.println("SQLException: " + var24.getMessage());
                System.out.println("SQLState: " + var24.getSQLState());
                System.out.println("VendorError: " + var24.getErrorCode());
            } finally {
    ...
    public Optional<ResultSet> executeQuery(String sql) {
        ...
        if (!this.isConnected()) {
            ...
            try {
                ...
                System.out.println("SQLDataStorage.execute");
                System.out.println("SQLException: " + var18.getMessage());
                System.out.println("SQLState: " + var18.getSQLState());
                System.out.println("VendorError: " + var18.getErrorCode());
                return Optional.empty();
            }
        }
    }
