...
public enum Lang {
    ...
    DEVELOPED("DEVELOPED", "<GOLD>Developed by: "),
    ...
    DO_NOT_MEET_REQUIREMENTS_FOR("DO-NOT-MEET-REQUIREMENTS-FOR", "You do not meet requirements for #<GOLD>{0}<RED>:"),
    ...
    LEADERBOARD_FOOTER("LEADERBOARD-FOOTER", "<GREEN>------------------------------------"),
    LEADERBOARD_HEADER_ALL_TIME("LEADERBOARD-HEADER-ALL-TIME", "<GREEN>-------- Leaderboard (All time) --------"),
    LEADERBOARD_HEADER_DAILY("LEADERBOARD-HEADER-DAILY", "<GREEN>-------- Leaderboard (Daily time) --------"),
    LEADERBOARD_HEADER_MONTHLY("LEADERBOARD-HEADER-MONTHLY", "<GREEN>-------- Leaderboard (Monthly time) --------"),
    LEADERBOARD_HEADER_WEEKLY("LEADERBOARD-HEADER-WEEKLY", "<GREEN>-------- Leaderboard (Weekly time) --------"),
    ...
    PATH("PATH", "<GREEN>Path '<GOLD>{1}<GREEN>' has been completed for {0}"),
    ...
    REQUIREMENTS("REQUIREMENTS", "<GREY>Requirements:"),
    ...
    YOU_ARE_A_ROBOT("YOU-ARE-A-ROBOT", "<RED>You are a robot, {0}"),
