...
public enum Lang {
    ...
    ACTIVE("ACTIVE", "<LIGHT_PURPLE>Active paths (<GOLD>"),
    ...
    COMPLETED("COMPLETED", "<LIGHT_PURPLE>Completed paths (<GOLD>"),
    ...
    DEVELOPED("DEVELOPED", "<GOLD>Developed by: <GRAY>"),
    ...
    GLOBAL("GLOBAL", "<LIGHT_PURPLE>Global playtime: "),
    ...
    LOCAL("LOCAL", "<LIGHT_PURPLE>Local playtime: "),
    ...
    VERSION("VERSION", "<GOLD>Version: <GRAY>"),
